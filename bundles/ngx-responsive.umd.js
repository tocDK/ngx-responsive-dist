(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('ngx-responsive', ['exports', '@angular/core', 'rxjs', 'rxjs/operators'], factory) :
	(factory((global['ngx-responsive'] = {}),global.ng.core,global.rxjs,global.Rx.Observable.prototype));
...
var ResponsiveState = /** @class */ (function () {
    function ResponsiveState(_responsiveConfig) {
        ...
        var _resize$ = rxjs.fromEvent(this._window, 'resize')
            .pipe(operators.debounceTime(this._responsiveConfig.config.debounceTime), operators.defaultIfEmpty(), operators.startWith(this.getWidth('window')));
